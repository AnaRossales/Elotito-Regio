...
def login():
    if request.method == 'POST':
        ...
        usuario_db = db_manager.get_usuario_por_nombre(conexion_db, usuario_input)
        
        # Validar si el usuario existe y si la contraseña encriptada coincide
...
def guardar_evento():
    ...
    nuevo_evento = Evento(
        ...
        id_usuario=session.get('usuario_id'), # ¡NUEVO!
